...
CREATE TABLE `employee` (
  ...
  `supirior_id` smallint(5) unsigned NOT NULL,
  `first_name` varchar(20) DEFAULT NULL,
  `last_name` varchar(10) DEFAULT NULL,
  `salary` decimal(5,4) DEFAULT NULL,
  ...
  KEY `fk_supirior_employee` (`supirior_id`),
  ...
  CONSTRAINT `fk_supirior_employee` FOREIGN KEY (`supirior_id`) REFERENCES `employee` (`employee_id`)
...
-- Dump completed on 2015-12-04 12:14:02
